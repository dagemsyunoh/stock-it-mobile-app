...
abstract public class ReceiptBaseViewHolder extends RecyclerView.ViewHolder {
    ...
    public ReceiptBaseViewHolder(View itemView, ReceiptListeners receiptListeners) {
        super(itemView);
    ...
    protected ReceiptListeners getListener() {
        return receiptListeners;
    }
    ...
    public abstract void bindDataToViewHolder(ReceiptModel item, int position, SwipeState swipeState);
}