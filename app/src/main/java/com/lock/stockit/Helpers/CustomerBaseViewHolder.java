...
abstract public class CustomerBaseViewHolder extends RecyclerView.ViewHolder {
    ...
    protected CustomerListeners getListener() {
        return customerListeners;
    }
    ...
    public abstract void bindDataToViewHolder(CustomerModel item, int position, SwipeState swipeState);
}