...
abstract public class StockBaseViewHolder extends RecyclerView.ViewHolder {
    ...
    public StockBaseViewHolder(View itemView, StockListeners stockListeners) {
        super(itemView);
    ...
    protected StockListeners getListener() {
    ...
    public abstract void bindDataToViewHolder(StockModel item, int position, SwipeState swipeState);
}